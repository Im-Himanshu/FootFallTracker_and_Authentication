...
@Component({
  selector: 'app-actual-tensor-flow',
  templateUrl: './actual-tensor-flow.component.html',
  styleUrls: ['./actual-tensor-flow.component.scss'],
})
export class ActualTensorFlowComponent implements OnInit {
