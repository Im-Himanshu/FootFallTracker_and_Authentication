...
@Component({
  ...
  templateUrl: './simon-video-stream-with-storage.component.html',
  styleUrls: ['./simon-video-stream-with-storage.component.scss'],
})
export class SimonVideoStreamWithStorageComponent implements OnInit {
